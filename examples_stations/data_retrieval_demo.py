    ...
    while count < 10:
        ...
        if count % 3 == 0:
            ...
            for i, pts in enumerate([point_values_0, point_values_1, point_values_2]):
                ...
                print(f"update index {i} with {p_val}")
        ...
        #            opendnp3.Header().AllObjects(2, 1),
        #            opendnp3.Header().AllObjects(30, 1),
        #            ]
        headers = [
                   opendnp3.Header().AllObjects(30, 1),
                   ]
        cmd_interface_master.application.master.PerformFunction("disable unsolicited",
